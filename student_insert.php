...
<form action="student_insert.php" method="post" class="form-horizontal" role="form">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="hall_id" placeholder="Enter Hall Name">
                </div>
            </div>

            <div class="form-group">
                <label for="gpa" class="col-sm-2 control-label">CGPA:</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="gpa" placeholder="Enter student's total CGPA">
                </div>
            </div>
